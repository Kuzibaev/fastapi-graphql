...
from tests.graphql.queries import get_users_query, get_specific_user_query, get_sticky_notes_query, \
    get_specific_sticky_note_query
from tests.graphql.mutations import create_user, create_sticky_notes, delete_specific_user, update_specific_sticky_note, \
